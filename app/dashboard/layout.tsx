...
export default async function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-clay-bg flex">
      {/* Sidebar */}
      <aside className="hidden md:flex flex-col w-60 bg-white border-r-2 border-[#E8E4FF] flex-shrink-0">
        {/* Logo */}
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5" aria-label="Sidebar navigation">
          {[
            ...
            { label: "Projects", href: "/dashboard/projects", icon: "M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z", active: false },
            { label: "Tasks", href: "/dashboard/tasks", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2", active: false },
            { label: "Team", href: "/dashboard/team", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0", active: false },
          ].map((item) => (
            <a
              key={item.label}
              href={item.href}

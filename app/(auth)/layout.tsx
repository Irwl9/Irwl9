  ...
  return (
    <div className="min-h-screen bg-clay-bg flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <a
          href="/"
          className="font-display tracking-tight flex items-center gap-2 font-black text-xl text-clay-primary mb-8 w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-clay-primary rounded-md"

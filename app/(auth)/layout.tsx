  ...
  return (
    <div className="min-h-screen bg-clay-bg flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        >
          <span className="w-8 h-8 rounded-xl bg-clay-primary flex items-center justify-center text-white text-sm font-black shadow-clay-sm border-2 border-[#6356D5]">
            F
          </span>
          FlowSaaS
        </a>
